...
int						init_first_inter(t_cast *h_cast, t_cast *v_cast,
							t_mlx *mlx, int index);
...
int						vertical_raycast(t_mlx *mlx, float gap, int index,
							t_cast *v_cast);
int						horizontal_raycast(t_mlx *mlx, float gap, int index,
							t_cast *h_cast);
void					build_rays(t_mlx *mlx, int rays_count);
void					raycaster(t_mlx *mlx);
bool					check_walls(t_mlx *mlx, float x, float y);
void					init_data(t_mlx *mlx, t_cube *cube, t_player *p,
							t_map *map);
